...
export const USER_PROFILE_URL = process.env.API_URL + '/users/{userId}';
...
export const RECONSTRUCTION_ADD_IMAGE_URL =
  process.env.API_URL + '/reconstructions/{reconstructionId}/addImage';
...
export const RECONSTRUCTION_OUTPUT_URL =
  process.env.API_URL + '/reconstructions/{reconstructionId}/reconstructionFile';
